    ...
    "element": (
      <span>
        ...
        <SettingGroup name="Sidebar">
          ...
          <Setting name="Smaller Icons" setting="sidebar-smaller-icons" description="Decrease the size of sidebar icons." defaultValue="9" customInput={(state, setState) => { return <Slider state={state} setState={setState} min="1" max="25"  defaultval="9"/> }} />
