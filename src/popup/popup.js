        ...
        <span>
          <SettingGroup name="Navigation">
            <Setting
              name="Search"
              setting="search"
              description="Search through your courses anywhere on Canvas."
            />
            <Setting
            ...
            <Setting
              name="Speed Boost"
              setting="quicklink"
              description="Improve loading speeds by preloading links. May cause 403 Forbidden errors."
            />
          </SettingGroup>
          <SettingGroup name="Other">
            ...
            <Setting
              name="Quick Inbox"
              setting="convopeeker"
              description="View your emails without opening a new page, just click the inbox button."
            />
            <Setting
              name="Quiz Refill"
              setting="quizrefill"
              description="(Currently disabled due to bugs) Automaticlly import your previous answers. Only works when answers are shown."
            />
            <Setting
              name="Allow Surveys"
              setting="$canvasplus-allow-surveys"
              description="From time to time, the Canvas+ team releases surveys to help improve your learning."
            />
          </SettingGroup>
        </span>
      ),
        ...
        <span>
          ...
          <SettingGroup name="Sidebar">
            <CustomizableSetting
              ...
              customizationContent={(enabled) => {
                return (
                  <SidebarDrawerExpansionCustomization
            ...
            <Setting
              ...
              defaultValue="#1b7ecf"
              customInput={(state, setState) => {
                return (
                  <SidebarBackgroundColorPicker
                    state={state}
                    setState={setState}
                  />
                );
            ...
            <Setting
              ...
              description="Change the background color of the active sidebar button."
              defaultValue={{ background: "darker", icon: "white" }}
              customInput={(state, setState) => {
                return (
                  <ActiveSidebarColorSwitch state={state} setState={setState} />
                );
              }}
            />
            <Setting
              ...
              customInput={(state, setState) => {
                return (
                  <LimitedColorSwitch
                    state={state}
                    setState={setState}
                    generateTooltip={(color) => {
                      if (color === "unset") {
                        return (
                          <>
                            <b>Default Icons</b>
                            <p>
                              Sidebar icons will inherit the default colors of
                              your school.
                            </p>
                          </>
                        );
                        ...
                        return (
                          <>
                            ...
                            <p>Sidebar icons will always appear in {color}.</p>
                          </>
                        );
                      } else {
                        return (
                          <>
                            <b>Custom Icons</b>
                            <p>
                              Click to open a color wheel and chose a custom
                              icon color.
                            </p>
                          </>
                        );
            ...
            <Setting
              ...
              description="Increase or decrease the size of sidebar icons."
              defaultValue={3}
              customInput={(state, setState) => {
                return (
                  <Slider
                    ...
                    bubbleRenderer={(bubble) => {
                      if (bubble === 5) return "Normal";
                      else if (bubble > 5) return "Large";
                      else if (bubble < 5) return "Small";
                    }}
                  />
                );
              }}
            ...
            <Setting
              ...
              description="Quick access to settings with a button on the sidebar."
            />
          </SettingGroup>
          <SettingGroup name="Other">
            <Setting
              ...
              defaultValue=""
              customInput={(state, setState) => {
                return <ColorSwitch state={state} setState={setState} />;
              }}
            />
            <Setting
              name="Hide Logo"
              setting="hidelogo"
              description="Hide the logo on the top of the sidebar and todo."
            />
          </SettingGroup>
        </span>
      ),
