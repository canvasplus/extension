...
delayedQuerySelector("#header .ic-app-header__main-navigation #menu.ic-app-header__menu-list #global_nav_conversations_link").then((element) => {
  ...
  more.innerHTML = '<button id="global_nav_settings_link" class="ic-app-header__menu-list-link"><div class="menu-item-icon-container" aria-hidden="true"><svg class="ic-icon-svg menu-item__icon svg-icon-history" style="width: calc(var(--sidebar-icon-width, 26px) * 1.2) !important;" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1726.67 348.06"><g id="Layer_2" data-name="Layer 2"><circle cx="863.33" cy="174.03" r="174.03"/><circle cx="1552.64" cy="174.03" r="174.03"/><circle cx="174.03" cy="174.03" r="174.03"/></g></svg></div><div class="menu-item__text">More</div></button>'
...
const createMoreExpansion = (more) => {
  ...
  edit.innerHTML = '<button id="global_nav_settings_link" class="ic-app-header__menu-list-link"><div class="menu-item-icon-container" aria-hidden="true"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1669 1920" class="ic-icon-svg menu-item__icon svg-icon-history" style="width: calc(var(--sidebar-icon-width, 26px) * 1.2) !important;"><defs><style>.cls-1,.cls-2{fill:none;}.cls-1{stroke:var(--ic-brand-global-nav-ic-icon-svg-fill);stroke-miterlimit:10;stroke-width:68.18px;}</style></defs><g id="Layer_2" data-name="Layer 2"><path class="cls-1" d="M306.55,403.4h832.14l2.61-306.35,472.15,455.11-480,463.94,2.61-306.35H306.55Z" transform="translate(-125.5)"/><path class="cls-1" d="M1613.45,1516.6H781.31L778.7,1823,306.55,1367.84l480-463.94-2.61,306.35h829.53Z" transform="translate(-125.5)"/><rect class="cls-2" width="1669" height="1920"/></g></svg></div><div class="menu-item__text">Edit</div></button>'
